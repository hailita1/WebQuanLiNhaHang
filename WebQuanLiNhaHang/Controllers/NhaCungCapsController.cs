...
namespace WebQuanLiNhaHang.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNhaCungCap,TenNhaCungCap,DiaChi,DienThoai")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNhaCungCap,TenNhaCungCap,DiaChi,DienThoai")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
